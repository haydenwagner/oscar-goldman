...
export class PostService {
  ...
  posts = [
    ...
    },
    {
      ...
      but if you want to use the git-bash shell instead of the default windows shell you need to change
    the 'shell path' in the WebStorm terminal settings.`,
      pubDate: "1/22/17",
      mainPoints: [
